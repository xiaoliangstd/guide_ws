...
FSM::FSM(CtrlComponents *ctrlComp)
    ...
    _stateList.rlWtw = new State_RlWtw(_ctrlComp);
    _stateList.threefootStand = new State_ThreefootStand(_ctrlComp);
...
FSMState* FSM::getNextState(FSMStateName stateName){
    ...
    case FSMStateName::STEPTEST:
        ...
        break;
    case FSMStateName::RLWTW:
        return _stateList.rlWtw;
        break;
    case FSMStateName::THREEFOOTSTAND:
        return _stateList.threefootStand;
        break;
#ifdef COMPILE_WITH_MOVE_BASE
